...
The repository should act as:

- A public product explanation hub
- A beginner tutorial index
- A creator workflow documentation center
...
Publish small useful updates over time:

- Week 1: Getting started guide and product overview
- Week 2: Novel workflow tutorial
- Week 3: Comic workflow tutorial
- Week 4: Character consistency guide
